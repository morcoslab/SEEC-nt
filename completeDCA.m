...
function Pairwisehfield=Compute_Results(Pi,Pij_true, Pi_true, invC, N, q,fp)
% computes and prints the mutual and direct informations
    ...
    for i=1:N
        for j=(i+1):N
            ...
            [Pairwisehfield(((i-1)*q+1):i*q,(2*j-1):2*j), DI_mf_pc]= bp_link(i,j,W_mf,Pi,q);
...
function [M] = calculate_mi(i,j,P2,P1,q)
...
function [hihj,DI] = bp_link(i,j,W,P1,q)
